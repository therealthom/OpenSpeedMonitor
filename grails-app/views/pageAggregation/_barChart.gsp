<div id="chart-container">
    ...
    <div class="in-chart-buttons">
        <a href="#downloadAsPngModal" id="download-as-png-button"
           data-toggle="modal" role="button" onclick="OpenSpeedMonitor.ChartModules.PngDownloader.initFor('#svg-container', OpenSpeedMonitor.ChartModules.PageAggregationBarChart)"
